...
public final class ModBlocks {
    ...
    public static final Block TOMATO_CROP = registerCrop("tomato", () -> ModItems.TOMATO_SEEDS);
    public static final Block ONION_CROP = registerCrop("onion", () -> ModItems.ONION_SEEDS);
    public static final Block CUCUMBER_CROP = registerCrop("cucumber", () -> ModItems.CUCUMBER_SEEDS);
    public static final Block CORN_CROP = registerCrop("corn", () -> ModItems.CORN_SEEDS);
    public static final Block BELL_PEPPER_CROP = registerCrop("bell_pepper", () -> ModItems.BELL_PEPPER_SEEDS);
    public static final Block STRAWBERRY_CROP = registerCrop("strawberry", () -> ModItems.STRAWBERRY_SEEDS);
    ...
    static Block registerCrop(String name, java.util.function.Supplier<net.minecraft.world.item.Item> seeds) {
